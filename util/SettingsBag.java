...
import myproject.util.TimeServerList;

public class SettingsBag {

	private static SettingsBag sb = null;
	
	private TimeServer timeServer = new TimeServerList();
	...
	private Double trafficLightGreenTimeMin = 15.0;
	private Double trafficLightGreenTimeMax = 25.0;
	private Double trafficLightRedTimeMin = 5.0;
	private Double trafficLightRedTimeMax = 10.0;	

	private SettingsBag() {

	}

	public static SettingsBag makeSettingsBag() {
		if (SettingsBag.sb == null) {
			SettingsBag.sb = new SettingsBag();
		}
		return SettingsBag.sb;
	}
	...
	public Double getTrafficLightRedTimeMin() {
		return trafficLightRedTimeMin;
	}

	public void setTrafficLightRedTimeMin(Double trafficLightYellowTimeMin) {
		this.trafficLightRedTimeMin = trafficLightYellowTimeMin;
	}

	public Double getTrafficLightRedTimeMax() {
		return trafficLightRedTimeMax;
	}

	public void setTrafficLightRedTimeMax(Double trafficLightRedTimeMax) {
		this.trafficLightRedTimeMax = trafficLightRedTimeMax;
	}
	...
	public String toString() {
		...
		b.append("Traffic light red time (seconds)  [min=" + this.getTrafficLightRedTimeMin() + ",max=" + this.getTrafficLightRedTimeMax() + "]\n");
		return b.toString();
	}
}
